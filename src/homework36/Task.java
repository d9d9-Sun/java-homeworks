...
public class Task {
    ...
    public static void main(String[] args) {
        Client client1 = new Client("Петя", 900, OperationType.GET_MONEY, 100);
        Client client2 = new Client("Вася", 700,OperationType.PUT_MONEY, 100);
        Client client3 = new Client("Гена", 500, OperationType.PAY_MONEY, 100);
        Client client4 = new Client("Миша", 300, OperationType.TRANSACTION_MONEY, 100);
        Client client5 = new Client("Люда", 200, OperationType.EXCHANGE_MONEY, 100);
